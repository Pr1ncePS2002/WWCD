    ...
    <main className="min-h-[100dvh] bg-black text-white">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
        <header className="text-center">
          ...
          <p className="mt-3 text-white/70">{"Tap a card to flip and reveal the chest piece champions."}</p>
        </header>
              ...
              <FlipCard
                ...
                back={
                  <WinnerTemplate
                    ...
                    imageUrl={result.winner1_card_url}
                    className="border-white/10 bg-white/[0.04]"
                  />
                }
              />
              <FlipCard
                ...
                back={
                  <WinnerTemplate
                    title="Winner 2"
                    subtitle="Chest Piece Champion"
                    imageUrl={result.winner2_card_url}
                    className="border-white/10 bg-white/[0.04]"
                  />
                }
              />
